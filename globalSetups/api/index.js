...
export const fetch50Orders = (obj) => callApiAndReturnDataGetMod(obj,'orders/')
export const orderStatusChange = (obj) => callApiAndReturnDataPut(obj,'orders/')
export const updateYourEarning = (obj) => callApiAndReturnDataPut(obj,'profile/byId/')